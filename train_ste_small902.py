...
def patch_linear_module_for_ste(module, module_idx, n_bits=4, step=0.07/7, ratio=0.9, mask_seed=2026):
...
def apply_ste_to_target_layers(model, n_bits=4, step=0.06, ratio=0.9, mask_seed=2026):
    patched = []
    module_idx = 0
